...
/// Selector directo de estado — alternativa al boton de flecha.
/// Se activa desde configuracion con useStatusSelector.
                      ...
                      : () {
                          if (!currentStatus.canTransitionTo(status)) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'No puedes ir directamente de '
                                  '"${currentStatus.displayLabel}" a '
                                  '"${status.displayLabel}"',
                                ),
